...
user 'oracle'
group 'oinstall'
command "export daas_node_instance=#{node[:daas_b2bx][:autowork]}/app/ &&  python daasohs.py setup >> #{node[:daas_b2bx][:autowork]}/log/daasohs.log 2>&1"
timeout 7200
...
user 'oracle'
group 'oinstall'
command "export daas_node_instance=#{node[:daas_b2bx][:autowork]}/app/ &&  python edq73ohs.py setup >> #{node[:daas_b2bx][:autowork]}/log/edq73ohs.log 2>&1"
timeout 7200
...
user 'oracle'
group 'oinstall'
command "export daas_node_instance=#{node[:daas_b2bx][:autowork]}/app/ &&  python daasprovohs.py setup >> #{node[:daas_b2bx][:autowork]}/log/daasprovohs.log 2>&1"
timeout 7200
...
user 'oracle'
group 'oinstall'
command "export daas_node_instance=#{node[:daas_b2bx][:autowork]}/app/ &&  python daasohs.py restart >> #{node[:daas_b2bx][:autowork]}/log/daasohs.log 2>&1"
timeout 7200
end
